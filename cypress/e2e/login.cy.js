...
describe('Orange HRM Tests', () => {
  ...
  it.only('User Info Update - success', () => {
    ...
    cy.get(selectorList.genericField).eq(7).clear({ force: true }).type('2026-07-07', { force: true })
    ...
    cy.get(selectorList.genericField).eq(9).clear({ force: true }).type('sinNumberTest', { force: true })
    cy.pause()
